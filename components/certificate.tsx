...
export default function Certificate({
  ...
  return (
    <motion.div
      ...
      className=" mb-3 sm:mb-8 last:mb-0 flex"
    >
      <section className="bg-gray-100 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-gray-200 transition  dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
        ...
        <Image
          src={imageUrl}
          alt="Certifications I have achieved"
          quality={95}
          className="absolute ml-auto hidden items-center justify-center sm:block top-5 right-10 w-[18rem] rounded-t-lg "
        />
      </section>
    </motion.div>
  );
